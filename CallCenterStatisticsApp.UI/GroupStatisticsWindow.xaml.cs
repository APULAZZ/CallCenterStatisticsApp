...
public partial class GroupStatisticsWindow : Window
{
    private readonly CallStatisticsService _statisticsService;

    public GroupStatisticsWindow(CallStatisticsService statisticsService)
    {
        InitializeComponent();
    ...
    private async Task LoadDataAsync()
    {
        ...
        SummaryTextBlock.Text = $"Групп в отчете: {rows.Count}";
    }
